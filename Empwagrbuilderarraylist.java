...
public class Empwagrbuilderarraylist implements ICompanyEmpwage {
	public static final int Part_Time = 1;
	public static final int Full_Time = 2;

	List<CompanyEmpwage> companyEmpwageArray = new ArrayList<CompanyEmpwage> ();

	public void addCompanyEmpWage(String company_name,int emp_rate_per_hour,int working_days,int max_hours_per_month){
		CompanyEmpwage e = new CompanyEmpwage(company_name , emp_rate_per_hour , working_days , max_hours_per_month);
	...
	public static void main(String[] args){
		Empwagrbuilderarraylist empwagrbuilder = new Empwagrbuilderarraylist();
		empwagrbuilder.addCompanyEmpWage("BridgeLabz",20,22,100);
		empwagrbuilder.addCompanyEmpWage("AnandWashingPowder",40,26,200);
