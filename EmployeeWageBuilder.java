public class EmployeeWageBuilder
{
	...
	{
		System.out.println("* Calculate Total Emp Wage For Bridgelabz Company *");
		Calculate_EmpWage("BridgeLabz",100,20,20);
		System.out.println("\n");
		System.out.println("* Calculate Total Emp Wage For VMart Company *");
      Calculate_EmpWage("VMart",10,15,10);
	}
}
